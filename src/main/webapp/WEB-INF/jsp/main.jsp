        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4" >
                    <img src="/resources/img/berry/iphone-berry.png" class="img-responsive scrollpoint sp-effect5" alt="">
                </div>
    ...
    <section id="screens">
        <div class="container">
            ...
            <div class="slider filtering scrollpoint sp-effect5" >
                <div class="one">
                    <img src="/resources/img/berry/screens/profile.jpg" alt="">
                    <h4>Profile Page</h4>
                </div>
                <div class="two">
                    <img src="/resources/img/berry/screens/menu.jpg" alt="">
                    <h4>Toggel Menu</h4>
                </div>
                <div class="three">
                    <img src="/resources/img/berry/screens/weather.jpg" alt="">
                    <h4>Weather Forcast</h4>
                </div>
                <div class="one">
                    <img src="/resources/img/berry/screens/signup.jpg" alt="">
                    <h4>Sign Up</h4>
                </div>
                <div class="one">
                    <img src="/resources/img/berry/screens/calendar.jpg" alt="">
                    <h4>Event Calendar</h4>
                </div>
                <div class="two">
                    <img src="/resources/img/berry/screens/options.jpg" alt="">
                    <h4>Some Options</h4>
                </div>
                <div class="three">
                    <img src="/resources/img/berry/screens/sales.jpg" alt="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                        <img src="/resources/img/berry/berry-angled2.png" alt="">
                    </div>
                    <div class="platforms">
